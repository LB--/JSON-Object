...
{
	PropData_StaticString(Prop::Version, (UINT_PTR)_T("Version #"), (UINT_PTR)_T("This is the current version of the JSON Object.")),
	PropData_URLButton(Prop::GitHub, (UINT_PTR)_T("GitHub Repo"), (UINT_PTR)_T("The source code repository for this extension."), (UINT_PTR)_T("https://github.com/LB--/JSON-Object")),
